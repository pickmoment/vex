...
impl AppLayout {
    ...
    fn render_help_overlay(f: &mut Frame, _app: &App) {
        ...
        let help_text = vec![
            ...
            Line::from("  r         새로고침"),
            Line::from("  g         Git 모드"),
            Line::from("  m         파일 관리 메뉴"),
            Line::from("  n         새 폴더 생성"),
            Line::from("  y         경로 클립보드 저장"),
            ...
            Line::from(""),
            Line::from("  ── Git 모드 ─────────────────"),
            Line::from("  a / u     스테이지 / 언스테이지"),
            Line::from("  c         커밋 입력"),
            Line::from("  L         커밋 로그 토글"),
            Line::from("  d/Enter   diff 보기"),
            Line::from("  f         diff 전체화면"),
            Line::from("  [ ]       수평 스크롤"),
            Line::from("  w         줄바꿈 토글"),
            Line::from("  X         선택 파일 변경 되돌리기"),
            Line::from(""),
            Line::from("  ── Git: 브랜치 ──────────────"),
            Line::from("  b         브랜치 패널 열기"),
            Line::from("  (패널) Enter  선택 브랜치로 전환"),
            Line::from("  (패널) n   새 브랜치 생성"),
            Line::from("  (패널) d   브랜치 삭제 (-d)"),
            Line::from("  (패널) D   브랜치 강제 삭제 (-D)"),
            Line::from(""),
            Line::from("  ── Git: 원격 동기화 ─────────"),
            Line::from("  p         pull"),
            Line::from("  P         push (--set-upstream)"),
            Line::from("  F         fetch --all --prune"),
            Line::from("  !         force push (확인 필요)"),
            Line::from(""),
            Line::from("  ── 경로 클립보드 ────────────"),
            Line::from("  y         현재 항목 경로 저장"),
            Line::from("  (복사/이동) Tab  경로목록 열기"),
            Line::from(""),
            Line::from("  ── 즐겨찾기 ──────────────────"),
